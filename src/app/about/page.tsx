...
export default function Page() {
  return (
    <main className="h-screen overflow-hidden">
      ...
      <div className="dark absolute inset-0 blur-sm bg-zinc-800 opacity-20 sm:hidden">
      ...
      <div className="flex flex-col justify-center items-center h-full text-center sm:flex-row sm:justify-between sm:text-center">
        <div className="z-20 sm:z-0 p-4 sm:w-1/2 sm:h-full sm:flex sm:flex-col sm:justify-center sm:bg-zinc-800 sm:bg-opacity-75">
          ...
          {"\n\n"}
          Aside from development, I am a student pilot with 21.3 flight hours and currently working towards my solo flight. I&apos;m a photograper, and I especially enjoy aviation photography. Every photo on my website is my own composition! I&apos;m also a student in high school.
          </div>
